...
@implementation CSIIKeychainTool

NSString * const KEY_UDID_INSTEAD = @"com.myapp.udid.test";
#pragma mark 获取唯一标识
+(NSString *)getDeviceIDInKeychain {
    NSString *getUDIDInKeychain = (NSString *)[CSIIKeychainTool load:KEY_UDID_INSTEAD];
    ...
    if (!getUDIDInKeychain ||[getUDIDInKeychain isEqualToString:@""]||[getUDIDInKeychain isKindOfClass:[NSNull class]]) {
        ...
        [CSIIKeychainTool save:KEY_UDID_INSTEAD data:result];
        getUDIDInKeychain = (NSString *)[CSIIKeychainTool load:KEY_UDID_INSTEAD];
    }
