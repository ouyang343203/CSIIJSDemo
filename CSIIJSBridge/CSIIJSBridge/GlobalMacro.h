...
#define KNavBarHeight ([CSIITool isiPhoneXScreen] ? 88 : 64)
//iphone x 底部圆角区域高度
#define kTabBarBottomHeight ([CSIITool isiPhoneXScreen] ? 34 : 0)
//iphone x StatusBar高度
#define KStatusBarHeight ([CSIITool isiPhoneXScreen] ? 44 : 20)
//iphone x TabBar+底部圆角区域高度
#define KTabBarHeight ([CSIITool isiPhoneXScreen] ? 83 : 49)
//分类标题栏高度
